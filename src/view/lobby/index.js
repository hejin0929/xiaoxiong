...
function Template(props) {
    ...
    return (<div className={IndexCss.template}>
        <div className={IndexCss.header}>
            <img className={IndexCss.headerImg} src="http://localhost/TYw1wIkEzd.jpg" alt="头像" />
            <div className={IndexCss.message}>
                ...
                <p>
                    ...
                    <span><i className="iconfont icon-liulan" /></span>
                    <span><i className="iconfont icon-pinglun" /></span>
                </p>
            </div>
        </div>
        <div>
